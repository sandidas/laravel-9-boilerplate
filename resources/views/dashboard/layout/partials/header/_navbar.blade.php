...
<div class="app-navbar flex-shrink-0">
	...
	@include('dashboard.partials.search._dropdown')
	...
	<div class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-35px h-35px w-md-40px h-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
	 ...
	 @include('dashboard.partials.menus._notifications-menu')
	...
	@include('dashboard.partials.menus._quick-links-menu')
	<!--end::Menu wrapper--></div>
	<!--end::Quick links-->
	<!--begin::Theme mode-->
	<div class="app-navbar-item ms-1 ms-lg-3">
	{{-- <!==layout-partial:partials/theme-mode/_main.html> --}}
	@include('dashboard.partials.theme-mode._main')
</div>
	<!--end::Theme mode-->
	<!--begin::User menu-->
	...
	@include('dashboard.partials.menus._user-account-menu')
	<!--end::Menu wrapper--></div>
	<!--end::User menu-->
